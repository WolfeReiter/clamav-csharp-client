...
namespace log4net.Repository.Hierarchy
{
	...
	/// </remarks>
	public class Hierarchy : LoggerRepositorySkeleton, IBasicRepositoryConfigurator, IDOMRepositoryConfigurator
	{
		...
		public Hierarchy(ILoggerFactory loggerFactory) : this(new PropertiesCollection(), loggerFactory)
		{
		}
		...
		#region Implementation of IDOMRepositoryConfigurator
		...
		#endregion Implementation of IDOMRepositoryConfigurator
