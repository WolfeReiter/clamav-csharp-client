...
{
	/// <summary>
	/// Assembly level attribute to configure the <see cref="DOMConfigurator"/>.
	/// </summary>
	/// <remarks>
	/// <para>
	...
	/// </para>
	/// <para>
	/// Use this attribute to configure the <see cref="DOMConfigurator"/>
	/// without calling one of the <see cref="DOMConfigurator.Configure()"/>
	/// methods.
	/// </para>
	/// </remarks>
	...
	public sealed class DOMConfiguratorAttribute : ConfiguratorAttribute
	{
		...
		/// the <see cref="DOMConfigurator"/>. This file path is relative to the
